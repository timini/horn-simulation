...
def main():
    ...
    screens=[lem_prescreen_candidates(candidates,drivers,t.f_low_hz,t.f_high_hz,band,num_frequencies=100,top_n=10,target=t) for t in targets]
    ...
    for c in candidates:
        ...
        run_simulation_from_step(str(step),band,100,{'length':c.length},str(csv),band[1],mesh_size=.008,radiation_model='flanged_piston')

...
| Local packages after review corrections | 349 passed | `results/validation-81/review7-local.xml` |
| Complete Nextflow suite after review fixes | All eighteen tests passed in one run, including loss/refinement, finite-flange/unflanged domain rejection, custom render paths, imported STEP coupling, default single-mode provenance and missing-band rejection | `results/validation-81/review8-nextflow.xml` |

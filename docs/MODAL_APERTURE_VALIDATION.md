...
This result covers one profile, geometry and target band under uniform inlet velocity. Production pressure-transfer integration, search recall, additional profiles/bands, finite-baffle behavior and actual driver/interface data need their own evidence. The current programme must continue reporting insufficient evidence for an uncharacterized assembly.
